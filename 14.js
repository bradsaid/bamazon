    ...
    inquirer.prompt([
        {
            ...
            name: 'choice',
            choices: ['Get songs by artist', 'Get artists who has multiple songs in top 5000', 'Select Songs with year range', 'Select by song title', 'Check if an artists song and album made it into the charts at the time of their release', 'Exit']
        }
        ...
        switch (answer.choice) {
            ...
            case 'Select by song title':
                ...
                case 'Check if an artists song and album made it into the charts at the time of their release':
                inquirer.prompt([
                    {
                        type: 'input',
                        name: 'song',
